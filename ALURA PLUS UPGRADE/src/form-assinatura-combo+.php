...
<head>      <!-– informações ao navegador-–>
    ...
    <title>Assinatura Combo+ </title>      <!-– titulo na aba-–>
...
<section class="container principal">     <!-– tag container que define uma seção no documento (cria um bloco) -–>
    <div class="container__caixa">       <!-– tag container "coringa" que agrupa elementos em um bloco-–>
        <h1 class="container__titulo"> Supere as expectativas do mercado de trabalho com o </h1>     <!-– tag título. Textos de títulos-–>
        ...
        <div>
            ...
            <div class="form ">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="senha" name="pass"  placeholder="Digite uma senha" required><br>
